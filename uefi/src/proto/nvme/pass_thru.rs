...
impl NvmePassThru {
    ...
    /// Sends an NVM Express command to the NVMe controller (Namespace ID 0).
    ///
    /// This method sends an NVMe Command Packet to the NVMe controller itself.
    ///
    /// # Parameters
    /// - `nvme_req`: The [`NvmeRequest`] containing the command and associated data to be sent.
    ///
    /// # Returns
    ...
    pub fn execute_command<'req>(
        ...
        unsafe {
            (self.0.pass_thru)(&mut self.0, 0, &mut req.packet, ptr::null_mut())
